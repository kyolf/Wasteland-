...
Game.InfoModal.prototype = {
    create: function(game) {
        ...
        createText(game, howToPlay, 450, 275, '40px Freckle Face', '#FFF', 'center');
        
        howToPlay = 'Up Arrow Key to Jump';
        createText(game, howToPlay, 600, 375, '40px Freckle Face', '#FFF', 'center');
        
        howToPlay = 'Left Arrow Key to Move Left and Right Arrow Key to Move Right';
        createText(game, howToPlay, 300, 475, '40px Freckle Face', '#FFF', 'center');
    }
};
